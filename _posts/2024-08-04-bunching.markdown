...
Here I will explain the basic concepts of bunching as a causal inference method. The full replication code is at the bottom of this post and also available on [GitHub](https://github.com/hugosantanna/bunching_example).
